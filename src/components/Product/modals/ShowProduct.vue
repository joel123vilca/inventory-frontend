<template>
  ...
  >
        ...
        <el-row :gutter="30">
          ...
          <el-col :span="12">
            <el-form-item label="Area" :label-width="formLabelWidth">
              <el-input v-model="product.area.name" autocomplete="off" autofocus="true"></el-input>
            </el-form-item>
          </el-col>

          <el-col :span="12">
            <el-form-item label="Marca" :label-width="formLabelWidth">
              <el-input v-model="product.brand.name" autocomplete="off" autofocus="true"></el-input>
            </el-form-item>
          </el-col>
    ...
    <span slot="footer" class="dialog-footer">
      <el-button @click="updateStateModalShow(!modalOpenShow)">Cerrar</el-button>
    </span>
  </el-dialog>
</template>
...
export default {
  ...
  computed: {
    ...mapState("products", ["product", "modalOpenShow"])
  },
  methods: {
    ...mapActions("products", ["updateStateModalShow"])
  }
};
</script>
