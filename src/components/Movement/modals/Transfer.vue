<template>
  ...
  >
    <el-form :model="form" class="formulario-creación" :label-position="labelPosition">
      <el-container>
        <el-row style="width:100%">
          ...
          <el-col :span="24">
            <el-form-item label="Area actual" :label-width="formLabelWidth">
              <el-input v-model="product.area.name" autocomplete="off" autofocus="true" disabled></el-input>
              <has-error :form="form" field="category" style="color:red"></has-error>
            </el-form-item>
          </el-col>

          <el-col :span="24">
            <el-form-item label="Área nueva" :label-width="formLabelWidth">
    ...
    <span slot="footer" class="dialog-footer">
      <el-button @click="updateStateModalTransfer(!modalOpenTransfer)">Cancel</el-button>
      <el-button type="primary" @click="createMovementSend()" icon="el-icon-check">Guardar</el-button>
    </span>
  </el-dialog>
</template>
