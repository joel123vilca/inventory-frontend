...
<div id="app">
		...
		<header>
			<div class="wrap">
				...
				<img src="http://idw.com.pe/image/logo.png" alt="logo">
                <el-dropdown class="avatar-container" trigger="click">
      <div class="avatar-wrapper">
        <img src="../../public/avatar.png" class="user-avatar">
      ...
      <el-dropdown-menu slot="dropdown" class="user-dropdown">
        ...
        <el-dropdown-item divided>
          <span style="display:block;" @click="cerrarSesión()">Logout</span>
        </el-dropdown-item>
      </el-dropdown-menu>
    </el-dropdown>
				<nav id="menu">
                    ...
                    <li><a>Reportes</a></li>
					<li><router-link tag="li" to="/products"><a>Products</a></router-link></li>
                    <li><router-link tag="li" to="/brands"><a>Brands</a></router-link></li>
                    <li><router-link tag="li" to="/Areas"><a>Areas</a></router-link></li>
					<li class="drop"><a v-on:click="display_drop_menu()">Menu de Areas <i class="icon-arrow"></i></a>
						<ul class="drop_menu">
							<a>Desarrollo</a>
							<a>Logistica</a>
							<a>Administracion</a>
